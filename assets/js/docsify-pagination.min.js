!(function (t, e) {
  ...
  var v = (function () {
    function n(t) {
      var e;
      (o(this, n), t) &&
        ((this.chapter = ((e = p(t, "div > ul > li")), c("p", e))),
        (this.hyperlink = m(t)));
    }
    return (
      l(n, [
          ...
          t &&
            (t.innerHTML = x.inner(
              (function (t, e) {
                try {
                  var n = t.route.path,
                    i = h(c.all(".sidebar li a")).filter(function (t) {
                      return !s(t, ".section-link");
                    }),
                    a = i.find(g(n)),
                    r = h((p(a, "ul") || {}).children).filter(function (t) {
                    ...
                    l = e ? i : r;
                  return {
                    prev: new v(l[o - 1]).toJSON(),
                    next: new v(l[o + 1]).toJSON(),
                  };
                } catch (t) {
                  return {};
                }
