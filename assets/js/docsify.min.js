!(function () {
                      ...
                      if (!(y instanceof R)) {
                        ...
                        if (A) {
                          ...
                          if (
                            ...
                            1 != $ && T.matchGrammar(e, t, n, v, b, !0, o),
                            a)
                          )
                            break;
                        } else if (a) break;
  ...
  (ee = Prism),
    Object.defineProperties((ee.languages["markup-templating"] = {}), {
      buildPlaceholders: {
        value: function (r, i, e, a) {
          if (r.language === i) {
            ...
            (r.code = r.code.replace(e, function (e) {
              ...
              for (var t, n = s.length; -1 !== r.code.indexOf((t = ne(i, n))); )
                ++n;
              return (s[n] = e), t;
            })),
  ...
  var ae = {
    ...
    se = function (i, e) {
      ...
      (s = r(n)
        ? n(j, t)
        : (j.setOptions(d(n, { renderer: d(t, n.renderer) })), j)),
        (this._marked = s),
  ...
  (se.prototype.compileEmbed = function (e, t) {
    ...
    if (((t = i), a.include)) {
      var s;
      if (
        (W(e) || (e = K(this.contentBase, X(this.router.getCurrentPath()), e)),
        a.type && (s = ae[a.type]))
      )
      ...
      return (
          ...
          function (e, t) {
            ...
            /{docsify-ignore}/g.test(r) &&
              ...
              /{docsify-ignore-all}/g.test(r) &&
                ...
                (a.ignoreAllSubs = !0));
            var s = B(i.id || r),
              o = u.toURL(u.getCurrentPath(), { id: s });
            return (
              (a.slug = o),
              c.toc.push(a),
              "<h" +
        ...
        (t.link = e.link =
          function (e, t, n) {
            ...
            return (
              (t = a),
              W(e) || c._matchNotCompileLink(e) || s.ignore
                ? ((r +=
                    0 === e.indexOf("mailto:") ? "" : ' target="' + o + '"'),
                  (r +=
                    0 === e.indexOf("mailto:")
                      ? ""
                      : "" !== l
        ...
        (t.image = e.image =
          function (e, t, n) {
            ...
            return (
              W(e) || (r = K(h, X(u.getCurrentPath()), e)),
              '<img src="' +
                r +
                '"data-origin="' +
                e +
    ...
    if (ye) {
      for (
        var t,
          ...
          o = ((s && s.scrollTop) || document.body.scrollTop) - ke,
          l = 0,
          c = r.length;
        l < c;
        l += 1
      ...
      if (t) {
        ...
        if (
          ...
          (a = h),
          !ve && v.classList.contains("sticky"))
        ) {
  ...
  function Fe(e) {
    (e = e || "<h1>404 - Not found</h1>"),
      ...
      !1 === this.config.executeScript || void 0 === window.Vue || Ce()
        ? this.config.executeScript && Ce()
        : setTimeout(function (e) {
  ...
  (Re.prototype.getBasePath = function () {
    ...
    (Re.prototype.toURL = function (e, t, n) {
      ...
      if (
        ((i.query = d({}, i.query, t)),
        (e = (e = i.path + V(i.query)).replace(/\.md(\?)|\.md$/, "$1")),
        r)
      ) {
        var a = n.indexOf("?");
  ...
  function qe(t, n, r, i, a, e) {
    (t = e ? t : t.replace(/\/$/, "")),
      (t = X(t)) &&
        R(a.router.getFile(t + r) + n, !1, a.config.requestHeaders).then(
          i,
          function (e) {
            return qe(t, n, r, i, a);
          },
  ...
  (Ue._init = function () {
    ...
    (e.config = (function () {
      ...
      (function (t) {
        var e,
          n = t.config;
        (e =
          "history" === (n.routerMode || "hash") && a ? new ze(n) : new Pe(n)),
          (t.router = e),
          je(t),
          (Ne = t.route),
        ...
        return (
          s
            ? ((s = this.router.getFile(a + s)),
              ...
              R(s + V(i, ["id"]), !1, r).then(function (e) {
    ...
    (Be._fetch404 = function (e, t, n) {
      ...
      if (o) {
        ...
        return (
          Ye(this.router.getFile(c), 0, s).then(
            function (e, t) {
